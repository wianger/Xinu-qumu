...
extern int _doscan(register char *, register int **, int (*getc)(int, char **),
 ...
 *------------------------------------------------------------------------
 */
int sscanf(char *str, /* String to read from		*/
 ...
 *------------------------------------------------------------------------
 */
static int sgetch(int dummy, /* Dummy unused variable	*/
 ...
 *------------------------------------------------------------------------
 */
static int sungetch(int dummy, /* Dummy unused variable	*/
