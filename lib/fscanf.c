...
extern int _doscan(register char *, register int **, int (*getc)(int, int),
                   int (*ungetc)(int, int), int, int);
 ...
 *------------------------------------------------------------------------
 */
int fscanf(int dev,   /* device to use		*/
 ...
 *------------------------------------------------------------------------
 */
static int getch(int dev, /* device to use		*/
 ...
 *------------------------------------------------------------------------
 */
static int ungetch(int dev, /* device to use		*/
                   int abuf /* buffer to use		*/
) {
  int *buf = (int *)abuf;
