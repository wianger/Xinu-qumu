#define INTEL_QUARK_SDIO_PCI_DID                                               \
  0x08A7 /* Intel Quark SDIO PCI Device ID	*/
#define INTEL_QUARK_SDIO_PCI_VID                                               \
  0x8086 /* Intel Quark SDIO MAC PCI Vendor ID	*/
...
struct sdmc_csreg {
  ...
  byte rsvd1[4];
  uint16 force_event_cmd12_err_stat; /* force event register for auto cmd12
                                        error status */
  uint16 force_event_err_int_stat;   /* force event register for error interrupt
                                        status */
...
#define SDMC_BLK_GAP_EVENT_STAT_EN                                             \
  0x0004                            /* Block Gap Event Status Enable	*/
#define SDMC_DMA_INT_STAT_EN 0x0008 /* DMA Interrupt Status Enable             \
                                     */
#define SDMC_BUF_WR_RDY_STAT_EN                                                \
  0x0010 /* Buffer Write Ready Status Enable	*/
#define SDMC_BUF_RD_RDY_STAT_EN                                                \
  0x0020                            /* Buffer Read Ready Status Enable	*/
...
#define SDMC_NML_INT_ALL_STAT_EN                                               \
  0x1FFF /* Enable all interrupt status		*/
...
#define SDMC_BLK_GAP_EVENT_SIG_EN                                              \
  0x0004                              /* Block Gap Event Signal Enable	*/
...
#define SDMC_NML_INT_ALL_SIG_EN                                                \
  0x1FFF /* Enable all interrupt signals		*/
...
#define SDMC_NML_INT_TX_COMP 0x0002  /* Transfer Complete                      \
                                      */
#define SDMC_NML_INT_BLK_GAP_EVENT                                             \
  0x0004                            /* Block Gap Event			*/
#define SDMC_NML_INT_DMA_INT 0x0008 /* DMA Interrupt			*/
#define SDMC_NML_INT_BUF_WR_RDY                                                \
  0x0010 /* Buffer Write Ready			*/
#define SDMC_NML_INT_BUF_RD_RDY                                                \
  0x0020                            /* Buffer Read Ready			*/
...
#define SDMC_NML_INT_BOOT_CK_RCV                                               \
  0x2000 /* Boot Acknowledge Received		*/
#define SDMC_NML_INT_BOOT_TER_INT                                              \
  0x4000                            /* Boot Terminate Interrupt		*/
#define SDMC_NML_INT_ERR_INT 0x8000 /* Error Interrupt			*/

/* Error Interrupt Status Enable */
#define SDMC_ERR_INT_CMD_TIMEOUT_ERR_STAT_EN                                   \
  0x0001 /* Command Timeout Error Status Enable	*/
#define SDMC_ERR_INT_CMD_CRC_ERR_STAT_EN                                       \
  0x0002 /* Command CRC Error Status Enable	*/
#define SDMC_ERR_INT_CMD_END_BIT_ERR_STAT_EN                                   \
  0x0004 /* Command End Bit Error Status Enable	*/
#define SDMC_ERR_INT_CMD_IND_ERR_STAT_EN                                       \
  0x0008 /* Command Index Error Status Enable 	*/
#define SDMC_ERR_INT_DATA_TIMEOUT_ERR_STAT_EN                                  \
  0x0010 /* Data Timeout Error Status Enable	*/
#define SDMC_ERR_INT_DATA_CRC_ERR_STAT_EN                                      \
  0x0020 /* Data CRC Error Status Enable		*/
#define SDMC_ERR_INT_DATA_END_BIT_ERR_STAT_EN                                  \
  0x0040 /* Data End Bit Error Status Enable	*/
#define SDMC_ERR_INT_CUR_LIMIT_ERR_STAT_EN                                     \
  0x0080 /* Current Limit Error Status Enable	*/
#define SDMC_ERR_INT_CMD12_ERR_STAT_EN                                         \
  0x0100 /* Auto CMD12 Error Status Enable	*/
#define SDMC_ERR_INT_ADMA_ERR_STAT_EN                                          \
  0x0200 /* ADMA Error Status Enable		*/
#define SDMC_ERR_INT_TUNE_ERR_STAT_EN                                          \
  0x0400 /* Tuning Error Status Enable		*/
#define SDMC_ERR_INT_TGT_RSP_ERR_EN                                            \
  0x1000 /* Target Response Error Status Enable	*/
#define SDMC_ERR_INT_CEATA_ERR_EN                                              \
  0x2000 /* CEATA Error Status Enable		*/
#define SDMC_ERR_INT_ALL_STAT_EN                                               \
  0x3FFF /* Enable all interrupt signals		*/

/* Error Interrupt Signal Enable */
#define SDMC_ERR_INT_CMD_TIMEOUT_ERR_SIG_EN                                    \
  0x0001 /* Command Timeout Error Signal Enable	*/
#define SDMC_ERR_INT_CMD_CRC_ERR_SIG_EN                                        \
  0x0002 /* Command CRC Error Signal Enable	*/
#define SDMC_ERR_INT_CMD_END_BIT_ERR_SIG_EN                                    \
  0x0004 /* Command End Bit Error Signal Enable	*/
#define SDMC_ERR_INT_CMD_IND_ERR_SIG_EN                                        \
  0x0008 /* Command Index Error Signal Enable 	*/
#define SDMC_ERR_INT_DATA_TIMEOUT_ERR_SIG_EN                                   \
  0x0010 /* Data Timeout Error Signal Enable	*/
#define SDMC_ERR_INT_DATA_CRC_ERR_SIG_EN                                       \
  0x0020 /* Data CRC Error Signal Enable		*/
#define SDMC_ERR_INT_DATA_END_BIT_ERR_SIG_EN                                   \
  0x0040 /* Data End Bit Error Signal Enable	*/
#define SDMC_ERR_INT_CUR_LIMIT_ERR_SIG_EN                                      \
  0x0080 /* Current Limit Error Signal Enable	*/
#define SDMC_ERR_INT_CMD12_ERR_SIG_EN                                          \
  0x0100 /* Auto CMD12 Error Signal Enable	*/
#define SDMC_ERR_INT_ADMA_ERR_SIG_EN                                           \
  0x0200 /* ADMA Error Signal Enable		*/
#define SDMC_ERR_INT_TUNE_ERR_SIG_EN                                           \
  0x0400 /* Tuning Error Signal Enable		*/
#define SDMC_ERR_INT_TGT_RSP_ERR_SIG_EN                                        \
  0x1000 /* Target Response Error Signal Enable	*/
#define SDMC_ERR_INT_CEATA_ERR_SIG_EN                                          \
  0x2000 /* CEATA Error Signal Enable		*/
#define SDMC_ERR_INT_ALL_SIG_EN                                                \
  0x3FFF /* Enable all interrupt signals		*/

/* Error Interrupt Status Register */
#define SDMC_ERR_INT_CMD_TIMEOUT_ERR                                           \
  0x0001 /* Command Timeout Error		*/
#define SDMC_ERR_INT_CMD_CRC_ERR                                               \
  0x0002 /* Command CRC Error			*/
#define SDMC_ERR_INT_CMD_END_BIT_ERR                                           \
  0x0004 /* Command End Bit Error		*/
#define SDMC_ERR_INT_CMD_INDEX_ERR                                             \
  0x0008 /* Command Index Error			*/
#define SDMC_ERR_INT_DATA_TIMEOUT_ERR                                          \
  0x0010 /* Data Timeout Error			*/
#define SDMC_ERR_INT_DATA_CRC_ERR                                              \
  0x0020 /* Data CRC Error			*/
#define SDMC_ERR_INT_DATA_END_BIT_ERR                                          \
  0x0040 /* Data End Bit Error			*/
#define SDMC_ERR_INT_CUR_LIMIT_ERR                                             \
  0x0080                              /* Current Limit Error			*/
...
#define SDMC_ERR_INT_TUNE_ERR 0x0400  /* Tuning Error                          \
                                       */
#define SDMC_ERR_INT_TGT_RSP_ERR                                               \
  0x1000                              /* Target Response Error		*/
...
#define SDMC_PRE_STATE_CMD_INHIBIT_CMD                                         \
  0x00000001 /* Command Inhibit		*/
#define SDMC_PRE_STATE_CMD_INHIBIT_DAT                                         \
  0x00000002                              /* Command Inhibit DAT		*/
#define SDMC_PRE_STATE_CRD_INS 0x00010000 /* Card Inserted		*/
#define SDMC_PRE_STATE_DATA_LN_SIG_LVL                                         \
  0x00F00000 /* Line Signal Level		*/

/* Clock Control Register */
#define SDMC_CLK_CTL_INT_CLK_EN                                                \
  0x0001 /* Internal Clock Enable		*/
#define SDMC_CLK_CTL_INT_CLK_STABLE                                            \
  0x0002                              /* Internal Clock Stable		*/
#define SDMC_CLK_CTL_SD_CLK_EN 0x0004 /* SD Clock Enable                       \
                                       */
#define SDMC_CLK_CTL_CLK_GEN_SEL                                               \
  0x0020 /* Clock Generator Select		*/
#define SDMC_CLK_CTL_SD_FREQ_HIGH_MASK                                         \
  0x00FF /* Mask to set SD clock frequency to max*/
...
#define SDMC_PWR_CTL_SD_BUS_VOL_SEL_CLR 0xF1  /* Clear mask for SD bus         \
                                                 voltage*/
...
#define SDMC_CMD_R1                                                            \
  (SDMC_CMD_CMD_RSP_ST | SDMC_CMD_CMD_IDX_EN | SDMC_CMD_CMD_CRC_EN)
#define SDMC_CMD_R1b                                                           \
  (SDMC_CMD_CMD_RSP_ST_BSY | SDMC_CMD_CMD_IDX_EN | SDMC_CMD_CMD_CRC_EN)
...
#define SDMC_CMD0                                                              \
  0x0000 | (SDMC_CMD_NO_RESP) /* CMD0 - Go Idle State	(Reset)		*/
#define SDMC_CMD2                                                              \
  0x0200 | (SDMC_CMD_R2) /* CMD2 - All send card identifier	*/
#define SDMC_CMD3                                                              \
  0x0300 | (SDMC_CMD_R6) /* CMD3 - Send relative card address	*/
#define SDMC_CMD7                                                              \
  0x0700 | (SDMC_CMD_R1b) /* CMD7 - Select/Deselect card		*/
#define SDMC_CMD8                                                              \
  0x0800 | (SDMC_CMD_R7) /* CMD8 - Voltage check			*/
#define SDMC_CMD9                                                              \
  0x0900 | (SDMC_CMD_R2) /* CMD9 - Send CSD			*/
#define SDMC_CMD10                                                             \
  0x0A00 | (SDMC_CMD_R2) /* CMD10 - Send CID			*/
#define SDMC_CMD12                                                             \
  0x0C00 | (SDMC_CMD_R1b) /* CMD12 - Stop Transmission		*/
#define SDMC_ABT                                                               \
  0x0C00 | (SDMC_CMD_TYPE_ABT) /* CMD12 - Abort			*/
#define SDMC_CMD13                                                             \
  0x0D00 | (SDMC_CMD_R1) /* CMD13 - Send status			*/
#define SDMC_CMD16                                                             \
  0x1000 | (SDMC_CMD_R1) /* CMD16 - Set block length		*/
#define SDMC_CMD17                                                             \
  0x1100 | (SDMC_CMD_R1 |                                                      \
            SDMC_CMD_DAT_PRES) /* CMD17 - Single block read		*/
#define SDMC_CMD55                                                             \
  0x3700 | (SDMC_CMD_R1) /* CMD55 - Application specific command	*/
#define SDMC_ACMD6 0x0600 | (SDMC_CMD_R1) /* ACMD6 - Set bus width	*/
#define SDMC_ACMD41                                                            \
  0x2900 | (SDMC_CMD_R3) /* ACMD41 - Card Initialization/Inquiry	*/
#define SDMC_ACMD51                                                            \
  0x3300 |                                                                     \
      (SDMC_CMD_R1 | SDMC_CMD_DAT_PRES) /* ACMD51 - Send SCR		*/
...
devcall sdmc_issue_cmd_sync(volatile struct sdmc_csreg *csrptr,
                            uint16 cmd_value, uint32 arg_value,
                            uint16 *error_sts, uint8 flags);
devcall sdmc_issue_cmd_async(volatile struct sdmc_csreg *csrptr,
                             uint16 cmd_value, uint32 arg_value);
devcall sdmc_finalize_cmd_async(volatile struct sdmc_csreg *csrptr,
                                uint16 *error_sts);